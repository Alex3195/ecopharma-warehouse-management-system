...
public class SectorSpecification {
    ...
    public static Specification<SectorEntity> hasName(String name) {
    ...
    public static Specification<SectorEntity> advancedFilter(Map<String, Object> filters) {
        Specification<SectorEntity> spec = isActive();
