...
public enum PermissionEnums {
    ...
    PRODUCT_RETURN_READ(Category.PRODUCT),
    PRODUCT_RETURN_CREATE(Category.PRODUCT),
    PRODUCT_RETURN_UPDATE(Category.PRODUCT),
    PRODUCT_RETURN_DELETE(Category.PRODUCT);
