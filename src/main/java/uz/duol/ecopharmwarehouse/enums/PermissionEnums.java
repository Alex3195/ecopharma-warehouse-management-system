...
public enum PermissionEnums {
    ...
    //PRINTER
    PRINTER_SETTING_CREATE(Category.PRINTER_SETTING),
    PRINTER_SETTING_READ(Category.PRINTER_SETTING),
    PRINTER_SETTING_UPDATE(Category.PRINTER_SETTING),
    PRINTER_SETTING_DELETE(Category.PRINTER_SETTING),
    //DEPARTMENT
    DEPARTMENT_CREATE(Category.DEPARTMENT),
    DEPARTMENT_READ(Category.DEPARTMENT),
    DEPARTMENT_UPDATE(Category.DEPARTMENT),
    DEPARTMENT_DELETE(Category.DEPARTMENT);
