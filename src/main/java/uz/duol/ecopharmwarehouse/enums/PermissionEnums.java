...
public enum PermissionEnums {
    ...
    //CROSS_DOCKING
    CROSS_DOCKING_CREATE(Category.CROSS_DOCKING),
    CROSS_DOCKING_GET(Category.CROSS_DOCKING),
    CROSS_DOCKING_UPDATE(Category.CROSS_DOCKING),
    CROSS_DOCKING_DELETE(Category.CROSS_DOCKING),
    //INVENTORY_SNAPSHOT
    INVENTORY_SNAPSHOT_CREATE(Category.INVENTORY_SNAPSHOT),
    INVENTORY_SNAPSHOT_GET(Category.INVENTORY_SNAPSHOT),
    INVENTORY_SNAPSHOT_UPDATE(Category.INVENTORY_SNAPSHOT),
    INVENTORY_SNAPSHOT_DELETE(Category.INVENTORY_SNAPSHOT),
    //LOCATION
    LOCATION_CREATE(Category.LOCATION),
    LOCATION_GET(Category.LOCATION),
    LOCATION_UPDATE(Category.LOCATION),
    LOCATION_DELETE(Category.LOCATION),
    //SECTOR_CHARACTERISTICS
    SECTOR_CHARACTERISTICS_CREATE(Category.SECTOR_CHARACTERISTICS),
    SECTOR_CHARACTERISTICS_GET(Category.SECTOR_CHARACTERISTICS),
    SECTOR_CHARACTERISTICS_UPDATE(Category.SECTOR_CHARACTERISTICS),
    SECTOR_CHARACTERISTICS_DELETE(Category.SECTOR_CHARACTERISTICS),
    //PRINTER
    WMS_PRINTER_SETTING_CREATE(Category.PRINTER_SETTING),
    WMS_PRINTER_SETTING_READ(Category.PRINTER_SETTING),
    WMS_PRINTER_SETTING_UPDATE(Category.PRINTER_SETTING),
    WMS_PRINTER_SETTING_DELETE(Category.PRINTER_SETTING),
    //DEPARTMENT
    WMS_DEPARTMENT_CREATE(Category.DEPARTMENT),
    WMS_DEPARTMENT_READ(Category.DEPARTMENT),
    WMS_DEPARTMENT_UPDATE(Category.DEPARTMENT),
    WMS_DEPARTMENT_DELETE(Category.DEPARTMENT),
    //OUT_BOUND_SHIPMENT
    OUTBOUND_SHIPMENT_GET(Category.OUT_BOUND_SHIPMENT),
    OUTBOUND_SHIPMENT_CREATE(Category.OUT_BOUND_SHIPMENT),
    OUTBOUND_SHIPMENT_UPDATE(Category.OUT_BOUND_SHIPMENT),
    OUTBOUND_SHIPMENT_DELETE(Category.OUT_BOUND_SHIPMENT),
    //CUSTOMER_SUPPLIER
    CUSTOMER_SUPPLIER_GET(Category.CUSTOMER_SUPPLIER),
    CUSTOMER_SUPPLIER_CREATE(Category.CUSTOMER_SUPPLIER),
    CUSTOMER_SUPPLIER_UPDATE(Category.CUSTOMER_SUPPLIER),
    CUSTOMER_SUPPLIER_DELETE(Category.CUSTOMER_SUPPLIER);
